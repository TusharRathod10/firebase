...
import 'package:firebase/RegisterLoginFirestore/DataFirestore.dart';
...
class RegisterFireStore extends StatefulWidget {
  RegisterFireStore({Key? key}) : super(key: key);

  @override
  State<RegisterFireStore> createState() => _RegisterFireStoreState();
}

class _RegisterFireStoreState extends State<RegisterFireStore> {
                            ...
                            onTap: () async {
                              if (globel.currentState!.validate()) {
                                ...
                                try {
                                  ...
                                  // Get.to(LoginFirestore(
                                  //   uid: user.doc('${userCredentials.user!.uid}'),
                                  // ));
                                  Get.off(
                                    FireStoreData(),
                                  );
